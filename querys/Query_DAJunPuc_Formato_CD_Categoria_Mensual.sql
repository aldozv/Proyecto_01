-- CD x Categoria x Formato (pack, via revenue_maestro_sku) mensual, gerencia PE Ger P4 DA Jun Puc.
-- Alimenta "Por Formato". Validar cobertura de join ("Sin mapear" no deberia traer volumen).
...
ORDER BY gerencia, anio, mes_num, centro, categoria_grupo, pack

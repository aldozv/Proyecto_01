...
-- Reemplazar 'PE Ger P4 Tarapoto','PE Ger P4 Iquitos','PE Ger P4 Pucall Hco','PE Ger P4 Huancay Ch','PE Ger P4 DA Jun Puc', 'CD Pucallpa','CD Huánuco','CD Tingo María','CD Tarapoto','CD Yurimaguas','CD Moyobamba','CD Iquitos','CD Huancayo','CD Chanchamayo','CD Satipo','CD Huancavelica','CD San Benedicto I (Ate)','CD Motupe','CD Chiclayo' (la UNION de todos los CD confirmados de
-- TODAS las gerencias del run -- no filtra cruzado porque gerencia+centro quedan juntos en
-- cada fila, ver reglas_negocio.md) y 202501/202609.

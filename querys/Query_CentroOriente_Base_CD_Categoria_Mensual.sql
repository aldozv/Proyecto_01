-- Base CD x Categoria mensual, por gerencia. Alimenta Total, Categoria y CD del dashboard.
-- CD acotado a la lista curada confirmada por gerencia (ver reglas_negocio.md / SKILL.md):
--   Pucallpa: CD Pucallpa, CD Huánuco, CD Tingo María
--   Tarapoto: CD Tarapoto, CD Yurimaguas, CD Moyobamba, CD Pucallpa (incluye el bloque DAs
--             abastecido desde CD Pucallpa, confirmado por el usuario 2026-08-27)
--   Iquitos:  CD Iquitos
...
GROUP BY
  ...
  CASE
    ...
    WHEN v.estratificacion IN ('Gaseosas','Agua','Maltas') THEN 'Nabs'
  END
ORDER BY v.gerencia, anio, mes_num, centro, categoria_grupo

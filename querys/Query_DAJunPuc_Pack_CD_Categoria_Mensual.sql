-- CD x Categoria x Pack (pack_xxx, via revenue_maestro_sku) mensual, gerencia PE Ger P4 DA Jun Puc.
-- Alimenta "Por Pack". Validar cobertura de join ("Sin mapear" no deberia traer volumen).
...
ORDER BY gerencia, anio, mes_num, centro, categoria_grupo, pack_xxx
